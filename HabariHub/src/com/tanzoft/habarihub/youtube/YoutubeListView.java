...
import com.tanzoft.habarihub.rss_activities.SplashActivity;

public class YoutubeListView extends SherlockActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(YoutubeListView.this,
	...
	public void refreshList(final MenuItem item) {
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				YoutubeListView.this.runOnUiThread(new Runnable() {
	...
	class CustomListAdapter extends BaseAdapter {
		...
		public CustomListAdapter(YoutubeListView activity) {
